package com.example.droidchat.ui.feature.signin.components.field
...
internal fun BodySigInField(
    ...
    Column(
        ...
        Spacer(modifier = Modifier.height(TopazSpacerSizeToken.XExtraLarge.horizontalHeight))

        PrimaryTextField(
            modifier = Modifier.padding(horizontal = TopazSpacerSizeToken.MMedium.horizontalHeight),
            value = email,
        ...
        Spacer(modifier = Modifier.height(TopazSpacerSizeToken.Medium.horizontalHeight))
