...
internal fun ChatMessageTextField(
    ...
    BasicTextField(
        ...
        modifier = modifier
            .fillMaxWidth()
            .border(
                width = TopazSpacerSizeToken.Small.horizontalHeight,
                color = Grey1,
            ...
            Column {
                Row(
                    modifier = Modifier
                        .fillMaxWidth()
                        .heightIn(
                            min = TopazSpacerSizeToken.ExtraLarge.horizontalHeight,
                            max = TopazSpacerSizeToken.XLSExtraLarge.horizontalHeight
                        )
                    ...
                    Box(
                        modifier = Modifier
                            .height(TopazSpacerSizeToken.MLarge.horizontalHeight)
                            .width(TopazSpacerSizeToken.Small.horizontalHeight)
                            .background(color = Grey1)
                    )

                    Spacer(modifier = Modifier.width(TopazSpacerSizeToken.MMedium.horizontalHeight))

                    Surface(
                        modifier = Modifier
                            .size(TopazSpacerSizeToken.MLarge.horizontalHeight)
                            .clickable {
                                onSendClicked()
                            },
                        shape = CircleShape,
