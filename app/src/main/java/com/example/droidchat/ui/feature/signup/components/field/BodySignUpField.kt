...
internal fun BodySigUpField(
    ...
    Column(
        ...
        Spacer(modifier = Modifier.height(TopazSpacerSizeToken.MLarge.horizontalHeight))
        ...
        Spacer(modifier = Modifier.height(TopazSpacerSizeToken.XMedium.horizontalHeight))
